# Corruptometro - Aplicação de Verificação de confiabilidade pública
hospedagem de teste: https://brasilcorrupt-dz2pgana.manus.space

# Investigador de Corrupção Política Brasil - TO DO
...
- [x] Implementar coletor Portal da Transparência (servidores, contratos, licitações, PEPs) (falta ativar a api no site teste)
- [x] Implementar coletor TSE (candidatos, doações, bens) (falta ativar a api no site teste)
